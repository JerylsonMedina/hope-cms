  ...
  return (
    <div>
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-400 text-sm mt-1">View sales transactions, revenue, and customer activity.</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-5 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-2xl font-bold text-slate-800">{loading ? '…' : (filtered.length ? `$${totalRevenue.toFixed(2)}` : '—')}</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-5 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-2xl font-bold text-slate-800">{loading ? '…' : (uniqueCustomers || '—')}</p>
          </div>
        </div>
      </div>
                ...
                filtered.map((sale, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-sm font-semibold text-emerald-600">
                      {sale.totalprice != null ? `$${parseFloat(sale.totalprice).toFixed(2)}` : '—'}
                    </td>
